...
export default class AvailableFlights extends React.Component {
	...
	static createReservationErrorMessage(errCode){

		if(errCode == 2){
			return (
				<>
					<p className="reservation-result-title">No se pudo realizar la reserva</p>
					<p className="reservation-result-body">El pasajero ingresado no existe, verifique sus datos y vuelva a intentarlo</p>
				</>
			) 
		} else {
			return (
